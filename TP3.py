...
def floorMode_drawBoard(app,canvas):
    for element in app.nodeLocation:
            ...
            cx+=app.count
            canvas.create_oval(cx+app.r,cy+app.r,cx-app.r,cy-app.r,fill='grey')
...
# Return a map that connects all these values#
    ...
    app.image2 = app.scaleImage(app.image1, 5/6)
    app.floor2= app.loadImage('WeanF2.PNG')
    app.floor2Scaled = app.scaleImage(app.floor2, 5/6)
    app.r=5
    ...
    "2000","2001A","2001B","2001C","2002A","2002","2005","2006","2008","2009","2011","2012","2015","2016","2014",
    ...
    "2006":(1560,330),"2009":(1550,270),"2008":(1550,245),"2011":(1570,270),"2012":(1570,245),"2015":(1550,210),
